...
AC_DEFUN([PHP_SETUP_ICU],[
  PKG_CHECK_MODULES_STATIC([ICU], [icu-uc >= 50.1 icu-io icu-i18n])
...
AC_DEFUN([PHP_SETUP_OPENSSL],[
  ...
  PKG_CHECK_MODULES_STATIC([OPENSSL], [openssl >= 1.0.2], [found_openssl=yes])
...
AC_DEFUN([PHP_SETUP_LIBXML], [
  PKG_CHECK_MODULES_STATIC([LIBXML], [libxml-2.0 >= 2.9.0])
...
AC_DEFUN([PHP_SETUP_EXPAT], [
  PKG_CHECK_MODULES_STATIC([EXPAT], [expat])
